...
def main():
    parser = argparse.ArgumentParser(description="Convert Proxmark3 MIFARE Classic .bin dump to KeyCard JSON format.")
    parser.add_argument("input_bin", help="Path to the Proxmark3 .bin dump file")
    parser.add_argument("-o", "--output", help="Output JSON file path", default="keycard_card.json")
